...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ApiResponse<Object>> handleBaseException(
    ...
    log.warn("Business exception [{}]: {} - Request: {} {}",
      traceId, ex.getMessage(), request.getMethod(), request.getRequestURI());
  ...
  public ResponseEntity<ApiResponse<Object>> handleBusinessException(
    ...
    String traceId = generateTraceId.generate();
    log.warn("Business logic error [{}]: {} - Request: {} {}",
      traceId, ex.getMessage(), request.getMethod(), request.getRequestURI());
  ...
  public ResponseEntity<ApiResponse<Object>> handleValidationException(
    ...
    String traceId = generateTraceId.generate();
    log.warn("Custom validation error [{}]: {} - Request: {} {}",
      traceId, ex.getMessage(), request.getMethod(), request.getRequestURI());
  ...
  public ResponseEntity<ApiResponse<Object>> handleWorkoutInProgress(
    ...
    String traceId = generateTraceId.generate();
    log.warn("Workout in progress [{}]: {} - Request: {} {}",
      traceId, ex.getMessage(), request.getMethod(), request.getRequestURI());
  ...
  public ResponseEntity<ApiResponse<Object>> handleRateLimitExceeded(
    ...
    String traceId = generateTraceId.generate();
    log.warn("Rate limit exceeded [{}]: {} - Request: {} {} - IP: {}",
      traceId, ex.getMessage(), request.getMethod(),
      request.getRequestURI(), getClientIp.getClientIp(request));
  ...
  public ResponseEntity<ApiResponse<Object>> handleAuthenticationException(
    ...
    log.warn("Authentication failed [{}]: {} - Request: {} {} - IP: {}",
      traceId, ex.getMessage(), request.getMethod(),
      request.getRequestURI(), getClientIp.getClientIp(request));
  ...
  public ResponseEntity<ApiResponse<Object>> handleAccessDeniedException(
    ...
    String traceId = generateTraceId.generate();
    log.warn("Access denied [{}]: {} - Request: {} {} - IP: {}",
      traceId, ex.getMessage(), request.getMethod(),
      request.getRequestURI(), getClientIp.getClientIp(request));
  ...
  public ResponseEntity<ApiResponse<Object>> handleMethodArgumentNotValid(
    ...
    String traceId = generateTraceId.generate();
    log.warn("Validation failed [{}]: {} validation errors - Request: {} {}",
  ...
  public ResponseEntity<ApiResponse<Object>> handleConstraintViolation(
    ...
    String traceId = generateTraceId.generate();
    log.warn("Constraint violation [{}]: {} violations - Request: {} {}",
      traceId, ex.getConstraintViolations().size(),
      request.getMethod(), request.getRequestURI());
  ...
  public ResponseEntity<ApiResponse<Object>> handleMethodNotSupported(
    ...
    String traceId = generateTraceId.generate();
    log.warn("Method not supported [{}]: {} not supported for {} - Supported: {}",
    ...
    ApiError error = ApiError.builder()
      ...
      .details(String.format("Supported methods: %s", Arrays.toString(ex.getSupportedMethods())))
      .metadata(metadata)
      .traceId(traceId)
      .build();
  ...
  public ResponseEntity<ApiResponse<Object>> handleHttpMessageNotReadable(
    ...
    String traceId = generateTraceId.generate();
    log.warn("Malformed JSON request [{}]: {} - Request: {} {}",
      traceId, ex.getMessage(), request.getMethod(), request.getRequestURI());
    ...
    if (cause instanceof InvalidFormatException) {
      ...
      userMessage = String.format("Invalid value for field '%s'", ife.getPath().get(0).getFieldName());
      details = String.format("Expected type: %s", ife.getTargetType().getSimpleName());
    } else if (cause instanceof MismatchedInputException) {
      MismatchedInputException mie = (MismatchedInputException) cause;
      if (!mie.getPath().isEmpty()) {
        userMessage = String.format("Invalid input for field '%s'", mie.getPath().get(0).getFieldName());
      }
    }
  ...
  public ResponseEntity<ApiResponse<Object>> handleMissingServletRequestParameter(
    ...
    String traceId = generateTraceId.generate();
    log.warn("Missing request parameter [{}]: {} - Request: {} {}",
      traceId, ex.getMessage(), request.getMethod(), request.getRequestURI());

    FieldError fieldError = FieldError.builder()
      .field(ex.getParameterName())
      .message(String.format("Required %s parameter '%s' is missing", ex.getParameterType(), ex.getParameterName()))
  ...
  public ResponseEntity<ApiResponse<Object>> handleMethodArgumentTypeMismatch(
    ...
    String traceId = generateTraceId.generate();
    log.warn("Type mismatch [{}]: {} - Request: {} {}",
      traceId, ex.getMessage(), request.getMethod(), request.getRequestURI());
  ...
  public ResponseEntity<ApiResponse<Object>> handleNoHandlerFound(
    ...
    String traceId = generateTraceId.generate();
    log.warn("No handler found [{}]: {} {} - Headers: {}",
      traceId, ex.getHttpMethod(), ex.getRequestURL(), ex.getHeaders());
  ...
  public ResponseEntity<ApiResponse<Object>> handleDataIntegrityViolation(
    ...
    String traceId = generateTraceId.generate();
    log.error("Data integrity violation [{}]: {} - Request: {} {}",
      traceId, ex.getMessage(), request.getMethod(), request.getRequestURI());
  ...
  public ResponseEntity<ApiResponse<Object>> handleOptimisticLockException(
    ...
    String traceId = generateTraceId.generate();
    log.warn("Optimistic lock exception [{}]: {} - Request: {} {}",
      traceId, ex.getMessage(), request.getMethod(), request.getRequestURI());
  ...
  public ResponseEntity<ApiResponse<Object>> handleEntityNotFoundException(
    ...
    String traceId = generateTraceId.generate();
    log.warn("Entity not found [{}]: {} - Request: {} {}",
      traceId, ex.getMessage(), request.getMethod(), request.getRequestURI());
  ...
  public ResponseEntity<ApiResponse<Object>> handleMaxSizeException(
    ...
    String traceId = generateTraceId.generate();
    log.warn("File size exceeded [{}]: {} - Request: {} {}",
      traceId, ex.getMessage(), request.getMethod(), request.getRequestURI());
    ...
    ApiError error = ApiError.builder()
      ...
      .details(String.format("Maximum allowed size: %s", formatFileSize.formatFileSize(ex.getMaxUploadSize())))
      .metadata(metadata)
      .traceId(traceId)
      .build();
