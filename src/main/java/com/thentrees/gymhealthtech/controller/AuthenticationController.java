...
public class AuthenticationController {
  ...
  @Operation(
    ...
    description = "Creates a new user account with profile information. Sends email verification upon successful registration.",
    ...
    try {
      ...
      if (bindingResult.hasErrors()) {
        ...
        return ResponseEntity.badRequest()
          .body(APIResponse.error("Validation failed", mapper.convertValue(apiError, ApiError.class)));
      }
