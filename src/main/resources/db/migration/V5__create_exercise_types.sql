...
ALTER TABLE exercises
  ADD COLUMN IF NOT EXISTS exercise_type VARCHAR(32);
...
ALTER TABLE exercises
  ADD CONSTRAINT fk_exercises_type
    FOREIGN KEY (exercise_type) REFERENCES exercise_types(code);

CREATE INDEX IF NOT EXISTS idx_exercises_type ON exercises(exercise_type);
-- Insert data into exercise_types
INSERT INTO exercise_types (code, name, image_url) VALUES
